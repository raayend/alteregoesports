...
export default function Dota2Division() {
  return (
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6">
                <img 
                  src="/assets/logos/logodota.jpg" 
                  alt="Dota 2 Logo" 
                  className="w-full h-full object-contain"
                />
              </div>
              <h1 className="text-display mb-4 text-white">
                Dota <span className="text-primary">2 Division</span>
              </h1>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-400 mb-8 text-lg">
                Our Dota 2 division is currently in development. We&#39;re working hard to bring you 
                the best competitive experience in this classic MOBA. Please check back later 
