...
import { mdlPlayers, mdlAchievements, Player, Achievement } from '../../utils';
import PremiumPlayerCard from '../../components/PremiumPlayerCard';

export default function MDLDivisionPage() {
  ...
  useEffect(() => {
    ...
    const loadLocalData = async () => {
      try {
        ...
        setPlayers(mdlPlayers);
        setAchievements(mdlAchievements);
        setLoading(false);
      } catch (err) {
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-16">
          <video
            ...
            src="/assets/videos/divisions/MLBB/mlbbtrailer.mp4"
            autoPlay
            muted
            loop
            playsInline
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6">
                <img
                  src="/assets/logos/logomdl.png"
                  alt="MLBB MDL Logo"
                  className="w-full h-full object-contain"
                />
              </div>
              <h1 className="text-display mb-4 text-white">
                Mobile Legends: <span className="text-primary">Development League</span>
              </h1>
              <p className="text-subheading text-gray-300 max-w-2xl mx-auto">
                Our competitive team competing in the Mobile Legends Development League, representing the future of Alter Ego Esports
              </p>
            </motion.div>
          </div>
        </section>

        {/* About MDL Division - NEW SECTION */}
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">About MDL</h3>
                <p className="text-gray-400">
                  The Mobile Legends Development League (MDL) is a competitive league that serves as a stepping stone for teams to enter the professional MPL scene. It&#39;s where future stars are born and developed.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400">
                  We focus on developing raw talent into professional players through intensive training, strategic gameplay, and mental fortitude. Our MDL team serves as the foundation for our future MPL roster.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400">
                  Our approach combines rigorous practice schedules, detailed gameplay analysis, and mentorship from our MPL players and coaching staff to ensure rapid growth and skill development.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                MDL <span className="text-primary">Team</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Our talented players competing in the Mobile Legends Development League
              </p>
            </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                Celebrating our journey in the Mobile Legends Development League
              </p>
            </motion.div>
