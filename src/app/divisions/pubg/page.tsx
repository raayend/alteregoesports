...
import { Player, Achievement } from '../../utils';
...
const pubgPlayers: Player[] = [
  {
    ...
    role: "Player",
    status: "Active",
    description: "Fikri \"Badru\" Imanudin Badru (born February 20, 2000) is an Indonesian player who is currently playing for Alter Ego Ares. He originally joined Alter Ego in 2019 and has been with the organization since then.",
    photo: "/assets/players/pubg/pubgm/badru.png",
    skills: [
  ...
  },
  {
    ...
    role: "Player",
    status: "Active",
    description: "Juventino \"Rosemary\" Ryan Jeremy Rolos (born June 22, 2003) is an Indonesian player who is currently playing for Alter Ego Ares. He was born in Manado, North Sulawesi, and joined Alter Ego Ares in February 2023.",
    photo: "/assets/players/pubg/pubgm/rosemary.jpg",
    skills: [
  ...
  },
  {
    ...
    role: "Player",
    status: "Active",
    description: "Juvanda \"Alva\" Fahrezy (born June 2, 2001) is an Indonesian player who is currently playing for Alter Ego Ares. He joined the team in July 2023 and is known as one of the best IGLs (In-Game Leaders) in the competitive scene.",
    photo: "/assets/players/pubg/pubgm/alva.jpeg",
    skills: [
  ...
  },
  {
    ...
    role: "Player",
    status: "Active",
    description: "Zhafir \"Krypton\" Eria is an Indonesian player who is currently playing for Alter Ego Ares. He joined the team in May 2025.",
    photo: "/assets/players/pubg/pubgm/krypton.jpg",
    skills: [
  ...
  },
  {
    ...
    role: "Player",
    status: "Active",
    description: "Moana is an Indonesian player who is currently playing for Alter Ego Ares. He joined the team in May 2025.",
    photo: "/assets/players/pubg/pubgm/moana.jpg",
    skills: [
  ...
  },
  {
    ...
    role: "Analyst",
    status: "Active",
    description: "Verdyansyah \"MxMoree\" Trialdi Putra (born August 28, 1997) is an Indonesian Coach and Analyst who is currently working for Alter Ego Ares. He joined as an analyst in February 2025.",
    photo: "/assets/players/pubg/pubgm/MxMoree.png",
    skills: [
  ...
  },
  {
    ...
    role: "Manager",
    status: "Active",
    description: "Muhammad \"Aces\" Haris is an Indonesian Manager who is currently working for Alter Ego Ares. He joined the organization in February 2023.",
    photo: "/assets/players/pubg/pubgm/aces.jpg",
    skills: [
...
const pubgAchievements: Achievement[] = [
  {
    id: 1,
...
export default function PUBGDivision() {
  ...
  useEffect(() => {
    ...
    const loadLocalData = async () => {
      try {
        ...
        setPlayers(pubgPlayers);
        setAchievements(pubgAchievements);
        setLoading(false);
      } catch (err) {
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-16">
          <video
            ...
            src="/assets/videos/divisions/PUBG/PUBGM/trailerpubgm.mp4"
            autoPlay
            muted
            loop
            playsInline
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              ...
              <p className="text-subheading text-gray-300 max-w-2xl mx-auto">
                Competing in PUBG Mobile tournaments across Southeast Asia
              </p>
            </motion.div>
          </div>
        </section>

        {/* About PUBG Division - NEW SECTION */}
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">About PUBG Mobile</h3>
                <p className="text-gray-400">
                  PUBG Mobile is a battle royale game where 100 players compete to be the last person or team standing. Our team excels in strategic gameplay, precise shooting, and tactical teamwork.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Our talented players competing in PUBG Mobile tournaments
              </p>
            </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                Celebrating our journey in PUBG Mobile competitions
              </p>
            </motion.div>
