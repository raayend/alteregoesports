...
import { mlbbPlayers, mlbbAchievements, Player, Achievement } from '../../utils';
import PremiumPlayerCard from '../../components/PremiumPlayerCard';

export default function MLBBDivision() {
  ...
  useEffect(() => {
    ...
    const loadLocalData = async () => {
      try {
        ...
        setPlayers(mlbbPlayers);
        setAchievements(mlbbAchievements);
        setLoading(false);
      } catch (err) {
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              ...
              <p className="text-subheading text-gray-300 max-w-2xl mx-auto">
                Our flagship competitive team competing in MPL Indonesia and other Southeast Asian tournaments
              </p>
            </motion.div>
          </div>
        </section>

        {/* About MLBB Division - NEW SECTION */}
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">Tentang Mobile Legends</h3>
                <p className="text-gray-400">
                  Mobile Legends: Bang Bang adalah permainan MOBA yang menguji keterampilan strategi, kerja tim, dan eksekusi. 
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                MLBB <span className="text-primary">Team</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Our talented players and coaching staff competing in Mobile Legends tournaments
              </p>
            </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                Celebrating our victories in the world&apos;s premier Mobile Legends tournaments
              </p>
            </motion.div>
