...
export default function ValorantPlayers() {
  return (
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6">
                <img 
                  src="/assets/players/logovalorant.jpg" 
                  alt="Valorant Logo" 
              ...
              <p className="text-subheading text-gray-300 max-w-2xl mx-auto">
                Meet the talented players representing Alter Ego Esports in Valorant tournaments
              </p>
            </motion.div>
          </div>
        </section>
