...
export default function Dota2Players() {
  return (
          ...
          <div className="container mx-auto px-6 relative z-20 text-center">
            ...
            >
              <div className="w-24 h-24 mx-auto mb-6">
                <img 
                  src="/assets/players/logodota.jpg" 
                  alt="Dota 2 Logo" 
                  className="w-full h-full object-contain"
                />
              </div>
              <h1 className="text-display mb-4 text-white">
                Dota <span className="text-primary">2</span>
              </h1>
              <p className="text-subheading text-gray-300 max-w-2xl mx-auto">
                Meet the talented players representing Alter Ego Esports in Dota 2 tournaments
              </p>
            </motion.div>
          </div>
        </section>
